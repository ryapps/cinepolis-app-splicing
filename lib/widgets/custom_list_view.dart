          ...
          child: SizedBox(
            ...
            child: ListView.separated(
              ...
              itemBuilder: (context, index) {
                return Container(
                  margin: widget.jenis != 'kategori' ? index == widget.itemCount - 1 ? EdgeInsets.only(right: 15,left: 0) : index == 0 ? EdgeInsets.only(left: 15, right: 10) : EdgeInsets.only(right: 10) : EdgeInsets.symmetric(horizontal:0) , 
